...
function Bing() {
  ...
  return (
    <div ref={ref} className={`bg-black border-8 border-blue-600 ${INFO_CARD_STYLE}`}>
      {loading ? (
        ...
        >
          ...
          {pic?.images && (
            <img
              ...
              src={BING_PIC_HOST + pic.images[0].url}
              alt={'error bing pic'}
            />
          )}
            ...
            >
              {(() => {
                ...
                return (
                  <div>
                    {showLocation && (
                      <div className={'text-xl py-3 mb-3 border-b-2 border-gray-300'}>
                        <a
                          className={'cursor-pointer hover:underline'}
                          href={pic.images[0].copyrightlink}
                          target={'_blank'}
                          rel="noreferrer"
                        >
                        ...
                        <div className={'text-gray-300 text-sm pt-1'}>
                          {image.slice(image.indexOf('('), image.length)}
                        </div>
